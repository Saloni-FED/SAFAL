const HistoryTimeline = () => {
    const events = [
        ...
        { year: '2007', description: 'MPSE demutualized at a premium of Rs. 30/- per share.' },
        ...
        { year: '2010', description: 'Agreement under section 13 with National Stock Exchange (NSE).' },
        { year: '2011', description: 'Approval of Securities and Exchange Board of India (SEBI) to NSE agreement.' },
        { year: '2012', description: 'Agreement under section 13 with Bombay Stock Exchange (BSE).' },
        { year: '2015', description: 'SEBI Exit Order in respect of Madhya Pradesh Stock Exchange Ltd (MPSE).' },
